...
contract ReduceVotingPeriod is Script {
    function run() external {
        ...
        UpdateSettingsCalldata memory settings = UpdateSettingsCalldata({
            ...
            // even when you're only adjusting the duration. The address below
            // is the Sepolia VanillaProposalValidationStrategy — if you've
            // swapped your Space onto a different validation strategy or
            // you're on a different chain, replace it with the one your
            // Space currently uses (read it via Space.proposalValidationStrategy()

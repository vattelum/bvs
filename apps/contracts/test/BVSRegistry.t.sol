...
contract BVSRegistryTest is Test {
    ...
    function test_getCategoryIdAt_revertsPastEnd() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(BVSRegistry.IndexOutOfRange.selector, 1, 1));
        registry.getCategoryIdAt(1);
    }

    function test_getCategoryIdAt_revertsOnEmptyRegistry() public {
        vm.expectRevert(abi.encodeWithSelector(BVSRegistry.IndexOutOfRange.selector, 0, 0));
    ...
    function test_getDocumentIdAt_revertsOnUnknownCategory() public {
        vm.expectRevert(abi.encodeWithSelector(BVSRegistry.CategoryDoesNotExist.selector, 0));
